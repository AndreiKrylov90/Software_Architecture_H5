...
public class Editor3D implements UILayer {
    ...
    // реализация нового метода из интерфейса UILayer
    @Override
    public void createNewModel3D(){
        initialize();
        System.out.println("Подождите, запускаем машину по созданию новой 3D модели ...");
        businessLogicalLayer.createModel3D();
