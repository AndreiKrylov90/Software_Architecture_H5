...
public class EditorBusinessLogicalLayer implements BusinessLogicalLayer {
    ...
    // Новый метод, реализующий интерфейс BusinessLogicalLayer, который вызывает соответствующий метод из слоя базы данных
    @Override
    public void createModel3D() {
        databaseAccess.newModel3D();
